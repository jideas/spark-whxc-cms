package com.spark.base.common.converter;
...
public class HttpMessageConverterGBKStr extends AbstractHttpMessageConverter<String> { 
//    public static final Charset DEFAULT_CHARSET = Charset.forName("UTF-8");
	public static final Charset DEFAULT_CHARSET = Charset.forName("GBK");
	private final List<Charset> availableCharsets;

	public HttpMessageConverterGBKStr() {
		this(DEFAULT_CHARSET);
	}

	public HttpMessageConverterGBKStr(Charset defaultCharset) {
