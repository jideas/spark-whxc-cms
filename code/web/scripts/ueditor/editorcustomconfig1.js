...
//图片上传配置区
,imageUrl:"/sparkcms/admin/image/uploadImage/"           //图片上传提交地址
,imagePath:"/sparkcms/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
//,toolbars:[["FontFamily","FontSize","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","Paragraph","RowSpacingBottom","RowSpacingTop","LineHeight","Indent","RemoveFormat","PastePlain","InsertImage","Emotion","Attachment","Unlink","Link","background"]]
//当鼠标放在工具栏上时显示的tooltip提示
//,labelMap:{'fontfamily':'','fontsize':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','paragraph':'','rowspacingbottom':'','rowspacingtop':'','lineheight':'','indent':'','removeformat':'','pasteplain':'','insertimage':'','emotion':'','attachment':'','unlink':'','link':'','background':'','':''}
//工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
,toolbars:[["Source","Undo","Redo","FontFamily","FontSize","Bold","Italic","Underline","StrikeThrough","ForeColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","Paragraph","Indent","RowSpacingBottom","RowSpacingTop","LineHeight","InsertImage","ImageNone","ImageLeft","ImageRight","ImageCenter","Link","Unlink","background"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'source':'','undo':'','redo':'','fontfamily':'','fontsize':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','paragraph':'','indent':'','rowspacingbottom':'','rowspacingtop':'','lineheight':'','insertimage':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','link':'','unlink':'','background':''}
...
,minFrameWidth:400    //编辑器最小宽度,默认800，拖动时以这个为准
...
//,initialStyle:'body{font-size:18px;font-family:宋体}'   //编辑器内部样式,可以用来改变字体等
