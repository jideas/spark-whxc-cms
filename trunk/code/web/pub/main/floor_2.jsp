...
<script type="text/javascript">
	$(function(){
		var floor_2Action = new FloorAction();
		floor_2Action.setArgs("#floor_2","./images/page/sort-bg02.png","#fba040");
	});		
</script>
	</head>
	<body>
	<div class="commonFloor" id="floor_2">
		<div class="floor_product"><div class="floor_line_dotted"></div>
		...
		<div class="floor_ad">
			<div>
				<a href="#">
					<img src="./images/page/ad02-01.png" />
				</a>
			</div>
			<div class="floor_ad_last">
				<a href="#">
					<img src="./images/page/ad02-02.png" />
				</a>
			</div>	
		</div>
	</div>
