...
<script type="text/javascript">
	$(function(){
		var floor_5Action = new FloorAction();
		floor_5Action.setArgs("#floor_5","./images/page/sort-bg05.png","#a2db4a");
	});		
</script>

	</head>
	<body>
	<div class="commonFloor" id="floor_5">
		...
		<div class="floor_ad">
			<div>
				<a href="#">
					<img src="./images/page/ad05-01.png" />
				</a>
			</div>
			<div>
				<a href="#">
					<img src="./images/page/ad05-02.png" />
				</a>
			</div>
			<div class="floor_ad_last">
				<a href="#">
					<img src="./images/page/ad05-03.png" />
				</a>
			</div>	
		</div>
	</div>
