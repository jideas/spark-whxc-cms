...
$(function(){
	...
	function validateQuestion(){
		...
		//问题8
		if($('input:checkbox[name="q8"]:checked').length < 3 || $('input:checkbox[name="q8"]:checked').length > 5){
	...
	<div id="questionnaire">
		...
		<div class="container">
			...
			<div class="bottomLine validate4">
				<p class="tip">04 ：您希望7号生活馆丰富以下哪些种类的商品？请选择0-3种。<span>[非必选]</span></p>
			...
			<div class="bottomLine validate6">
				<p class="tip">06 ：您觉得7号生活馆哪些种类的商品价格不够实惠？请选择0-3种。<span>[非必选]</span></p>
