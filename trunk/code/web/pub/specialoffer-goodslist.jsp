	...
	<body>
		<div class="categoryPagecontantRight">
			...
			<div class="categoryPagecontantRight2">
			  	<div class="orderDiv" id='special_orderDiv'>
				  	<!-- span class="orderBy">排序：</span>
					<span class="buttonInitClassLeft" id='btnSale' onclick="_specialOffApp.sort('0');">
						销  量
					</span>
					<span class="buttonInitClassLeft" id='btnPrice' onclick="_specialOffApp.sort('1');">
						价  格
					</span>
					<span class="buttonInitClassLeft" id="btnDate" onclick="_specialOffApp.sort('2');">
						上架时间
					</span> -->
			  	</div>
...
var _specialOffApp = null;
var _initSearchDataStr = '<%=goodsList%>';
var _pageSize = '<%=SearchConstant.PAGESIZE %>';
$(document).ready(function() {
	_specialOffApp = new SpecialOfferApp();
});
function SpecialOfferApp() {
	...
	*/
	...
	var load = function(pageIndex) {
		$.ajax({
			url: mainWeb + '/front/getSpeicalGoodsList',
	...
	var renderData = function(resultData) {
		...
		for (var index = 0; index < resultData.length; index++) {
			...
			html += "<div>";
			html += "<a class='goodsCellImage' target='_blank' href='" + mainWeb + "/front/toGoodsInfoPage?id=" + resultData[index].recid + "'";
			html += "><img width='130px' height='130px'";
			...
			html += "<img onclick=\"_specialOffApp.adjustGoodsCount('" + resultData[index].recid + "','-1') \"";
			...
			html += " onchange=\"_specialOffApp.countChangeListener('txt_" + resultData[index].recid + "')\">";
			html += "<img onclick=\"_specialOffApp.adjustGoodsCount('" + resultData[index].recid + "','1') \"";
			html += " src='" + mainWeb + "/images/page/button_sum.png'";
			html += " class='bellowGoodsSmallInfo_img_add' /> ";
			html += "<img onclick=\"_specialOffApp.buyGoods('" + resultData[index].recid + "') \"";
