...
//	}
	...
	/** default constructor */
	public EffectedOrderPo() {
	}

	/** minimal constructor */
	public EffectedOrderPo(byte[] recid) {
		this.recid = recid;
	}

	/** full constructor */
	public EffectedOrderPo(byte[] recid, Long recver, String billsno,
			byte[] memberid, String realname, String consignee,
			String consigneetel, String address, Date deliveryedate,
			String remark, Double disamount, Double totalamount, String type,
			byte[] stationid, String stationname, String status,
			Date createdate, byte[] consignorid, String consignor,
			Date consigneddate, byte[] deliverpersonid, String deliverperson,
			Date deliverdate, byte[] arrivedconfirmid, String arrivedconfirm,
			Date arrivedconfirmdate, String verificationcode,
