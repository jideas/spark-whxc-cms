 ...
 */
@Entity
@Table(name = "ERP_Sales_OnlineOrder_Det")
@SuppressWarnings("serial")
public class EffectedOrderDetPo implements java.io.Serializable {
	...
	/** default constructor */
	public EffectedOrderDetPo() {
	}

	/** minimal constructor */
	public EffectedOrderDetPo(byte[] recid) {
		this.recid = recid;
	}

	/** full constructor */
	public EffectedOrderDetPo(byte[] recid, Long recver, byte[] billsid,
